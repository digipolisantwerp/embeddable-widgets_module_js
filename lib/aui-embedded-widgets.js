...
var _zoid = _interopRequireDefault(__webpack_require__(/*! zoid */ "./node_modules/zoid/index.js"));
...
function define(identifier, options) {
  if (widgets[identifier]) {
    throw new Error("\"".concat(identifier, "\" was defined previously"));
  } else {
    // TODO: apply sane defaults (defaultLogLevel, tag, prerenderTemplate, ...)
    widgets[identifier] = _zoid.default.create(options);
