(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("auiEmbeddedWidgets", [], factory);
	else if(typeof exports === 'object')
		exports["auiEmbeddedWidgets"] = factory();
	else
		root["auiEmbeddedWidgets"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/widgets.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!************************!*\
  !*** ./src/widgets.js ***!
  \************************/
/*! exports provided: define, isDefined, load, render, renderUrl */
...
/* harmony import */ var zalgo_promise__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! zalgo-promise */ "./node_modules/zalgo-promise/index.js");
/* harmony import */ var zalgo_promise__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(zalgo_promise__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var zoid_dist_zoid_frame__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! zoid/dist/zoid.frame */ "./node_modules/zoid/dist/zoid.frame.js");
/* harmony import */ var zoid_dist_zoid_frame__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(zoid_dist_zoid_frame__WEBPACK_IMPORTED_MODULE_2__);
...
function xhrGet(url) {
  return new zalgo_promise__WEBPACK_IMPORTED_MODULE_1__["ZalgoPromise"](function (resolve, reject) {
...
function define(definition) {
  ...
  if (widgets[tag]) {
    ...
    widgets[tag] = zoid_dist_zoid_frame__WEBPACK_IMPORTED_MODULE_2___default.a.create(_extends(widgetDefaults, definition));
    return widgets[tag];
  }
}
/**
...
function load(url, overrides, force) {
  ...
  if (!loaded || force) {
    ...
    fetchedUrls[url] = xhrGet(url).then(function (response) {
      var options = _extends(JSON.parse(response), overrides, {
        originalUrl: url
      });
...
function renderUrl(url, props, elem, overrides) {
  return load(url, overrides).then(function (widget) {
    return widget.render(props, elem);
  });
}
...
//# sourceMappingURL=aui-embedded-widgets.js.map